...
import { NewTeamMemberModal } from "@/components/modals/new-team-member-modal";
      ...
      >
        <View className="px-4 space-y-4">
          ...
          <View className="flex-row items-center justify-between pt-2">
            <Text className="text-lg font-semibold text-foreground">Nossa Equipe</Text>
            <Button
              variant="default"
              size="sm"
          ...
          {filteredMembers.length === 0 ? (
            <EmptyState
              ...
              description={
                searchQuery
                  ...
                  : "Adicione o primeiro membro clicando no botão acima"
              }
            />
          ) : (
            <View className="gap-4">
              ...
              {!searchQuery && !canLoadMore && filteredMembers.length > ITEMS_PER_PAGE && (
                <View className="items-center pt-2">
