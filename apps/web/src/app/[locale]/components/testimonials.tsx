...
export const Testimonials = () => {
  ...
  return (
    ...
    >
      ...
      <p className="mt-2 text-center text-2xl font-semibold 2xl:text-3xl">{testimonials.title}</p>
        ...
        <div>
          ...
          <div className="mt-12 grid gap-6 max-sm:gap-16 sm:grid-cols-2">
            {testimonials.list.map((testimonial) => (
              <div key={testimonial.name} className="bg-base-100 card group relative p-1 shadow">
                <img
