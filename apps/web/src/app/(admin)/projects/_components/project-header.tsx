...
export function ProjectHeader({ searchQuery = "", onSearchChange }: ProjectHeaderProps) {
  ...
  return (
    <header className="flex items-center justify-between py-6">
      {/* Title */}
      <h1 className="text-3xl font-medium text-shadow-sm text-foreground">Projects</h1>
