  ...
  return (
    <header className="flex flex-col gap-4 py-4 md:py-6">
      ...
      <div className="flex items-center justify-between">
        <h1 className="text-2xl md:text-3xl font-medium text-shadow-sm text-foreground">Budgets</h1>
      ...
      <div className="relative w-full md:max-w-md md:mx-auto lg:absolute lg:left-1/2 lg:-translate-x-1/2 lg:top-6 lg:w-full lg:max-w-md">
        <Input
          type="search"
          placeholder="Search..."
          value={searchQuery}
