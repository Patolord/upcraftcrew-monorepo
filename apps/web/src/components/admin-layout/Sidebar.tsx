...
export const Sidebar = () => {
  ...
  const handleLogout = async () => {
    ...
    // SignOutButton is a component, not a function
    // The logout will be handled by Clerk's SignOutButton component
    router.push("/");
  };
      ...
      <div className="custom-scrollbar p-2 grow overflow-auto">
        <div className="mt-2">
          ...
          <div className="mt-1 space-y-0.5 px-2.5">
            ...
            <Link href="/budgets" className="menu-item group" title={isCollapsed ? "Budgets" : ""}>
            ...
            <Link href="/finance" className="menu-item group" title={isCollapsed ? "Finance" : ""}>
